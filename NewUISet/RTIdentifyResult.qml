...
Item {
                ...
                Rectangle {
                    ...
                    Rectangle{  //使图片边角有圆弧
                        ...
                        Connections{
                            ...
                            onCallQmlRefeshImg: {
                                if ((eachid)==index){
                                    var tmpss = theimage.source
                                    theimage.source = "image://CodeImg/"+index+ Math.random()
                                    if(scalerect.visible == true && tmpss == scaleImg.source)
    ...
    onVisibleChanged: {
        if (visible){
            CodeImage.initData(8);
            CodeImage.initData(9);
            CodeImage.initData(10);
            CodeImage.initData(11);
            scalerect.visible = false
        }
    }
}

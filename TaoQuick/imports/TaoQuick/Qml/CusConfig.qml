...
QtObject {
    ...
    property color controlBorderColor_hovered: Qt.darker(backgroundColor, 1.2)
    property color controlBorderColor_pressed: Qt.darker(backgroundColor, 1.4)

    property color controlColor
    property color controlColor_hovered: Qt.darker(backgroundColor, 1.2)
    property color controlColor_pressed: Qt.darker(backgroundColor, 1.4)
